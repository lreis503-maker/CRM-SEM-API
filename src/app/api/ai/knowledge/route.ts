  ...
  try {
    ...
    if (corrupt) {
      return NextResponse.json({
        ...
        id: doc.id,
        warning:
          "Salvo apenas com busca por palavras-chave. Não foi possível descriptografar sua chave de vetorização. Verifique ENCRYPTION_KEY e informe a chave novamente.",
      })
    }
